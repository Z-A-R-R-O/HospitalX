...
export function SwasthyaSetuView() {
  ...
  return (
    <div style={{ padding: "0", minHeight: "100%", color: "var(--ink)", animation: "fadeIn 0.3s ease" }}>
      <div style={{ marginBottom: "24px", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
        <div>
          <p style={{ color: "var(--muted)", margin: "0 0 4px 0", fontSize: "12px", textTransform: "uppercase", letterSpacing: "1px", fontWeight: 600 }}>Mobile Device Management</p>
          <h1 style={{ fontSize: "28px", fontWeight: "700", margin: 0, letterSpacing: "-0.5px", display: 'flex', alignItems: 'center', gap: '12px' }}>
            Connected Apps & Field Sync
            {isOfflineMode && (
      ...
      <div style={{ ...glassStyle, marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
          <div style={{ width: 60, height: 60, background: 'var(--blue)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff' }}>
             <Activity size={32} />
          </div>
          <div>
            <h2 style={{ margin: '0 0 4px 0', fontSize: '20px' }}>SwasthyaSetu Field Companion</h2>
            <p style={{ margin: 0, color: 'var(--muted)', fontSize: '14px' }}>Offline-first neurological screening app for rural health workers.</p>
          </div>
        </div>
        <div style={{ display: 'flex', gap: '12px' }}>
          <button 
             onClick={() => window.open('/health-worker', 'SwasthyaSetuApp', 'width=450,height=850,menubar=no,toolbar=no')}
             style={{ background: '#000', color: '#fff', padding: '10px 20px', borderRadius: '100px', border: 'none', fontWeight: 600, cursor: 'pointer', display: 'flex', gap: '8px', alignItems: 'center' }}
          >
             Open Mobile Version
          </button>
          <button 
      ...
      <h3 style={{ fontSize: '16px', margin: '0 0 16px 0', color: 'var(--ink)' }}>Field Triage Analytics</h3>
